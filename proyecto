...
int main()
{
	...
	fflush(stdin);
	printf("\t================================================================\t\t\t\n");
	printf("\t=========== ingrese codigo personal codigo de 6 digitos=========\t\t\t\n");
	printf("\t================================================================\t\t\t\n");
	scanf("%i",&nom.op);
	system("cls");
	if (nom.op==123456 & strcmp(nom.nombre,"Slender")== 0)
	{
		...
		do
		{
			//ingrese un if para codigo personal
			Menu(); //menú
	...
	{
	printf("Losentimos porfavor ingrese los datos correctos");
	}
...
{
	printf("\n\n");
	printf("\t\t\t =================== Sistema de gestión de inventario de productos ==================== == \n ");
